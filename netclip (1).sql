...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-11-2021 a las 22:56:42
...
INSERT INTO `direccion` (`ID_direccion`, `ID_usuario`, `departamento`, `Calle`, `apartamento`) VALUES
(1, NULL, 'canelones', 'peperone', 'b302'),
(2, NULL, 'montevideo', 'pabhsjfbw', 'b501');
...
(42, 'diego', 'bonora', '2156698554211236', '12/24', '156'),
(43, 'diego', 'bonora', '4563321447896632', '12/78', '124'),
(44, 'diego', 'bonora', '4444444444444444', '12/12', '123'),
(45, 'diego', 'bonora', '123123121231', '12/12', '123'),
(46, 'diego', 'bonora', '1231123112311231', '12/12', '123'),
(47, 'diego', 'bonora', '1231112311231231', '12/12', '123'),
(48, 'diego', 'bonora', '1231113112311231', '12/12', '123'),
(49, 'diego', 'bonora', '1233123312331233', '12/12', '123'),
(50, 'diego', 'bonora', '1452145214521452', '12/12', '123'),
(51, 'diego', 'bonora', '1591159115911591', '12/12', '123'),
(52, 'diego', 'bonora', '5555444422223333', '12/12', '123'),
(53, 'diego', 'bonora', '6666555544447777', '12/12', '123');
...
(1, '$2y$10$4Q9w/9ho1vfv0nXb4fPlXuvjRdCEYpsSx7QUaIZ9vdOAVKlpgvlR2', 'Diego', 'Bonora', 'bonoradi@gmail.com', NULL);
...
--
ALTER TABLE `tarjetas`
  MODIFY `ID_tarjetas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `usuarios_ibfk_1` FOREIGN KEY (`Num_tarjeta`) REFERENCES `tarjetas` (`ID_tarjetas`);
COMMIT;
